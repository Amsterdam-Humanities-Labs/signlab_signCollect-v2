...
const STRINGS = {
  ...
  // ── Glos Wizard ──────────────────────────────────────────────────────────
  'wizard.title':                { nl: 'Glos Wizard',                   en: 'Gloss Wizard' },
  'wizard.glos':                 { nl: 'Glos',                          en: 'Gloss' },
  'wizard.glos.placeholder':     { nl: 'Woord of glos…',                en: 'Word or gloss…' },
  'wizard.list':                 { nl: 'Glos lijst',                    en: 'Gloss list' },
  'wizard.list.placeholder':     { nl: 'Eén woord per regel…',          en: 'One word per line…' },
  'wizard.hint':                 { nl: 'Zoek een woord om te zien of het gebaar al bestaat.',
                                   en: 'Search a word to see whether the sign already exists.' },
  'wizard.searching':            { nl: 'Zoeken…',                       en: 'Searching…' },
  'wizard.no_results':           { nl: 'Geen resultaten gevonden',      en: 'No results found' },
  'wizard.truncated':            { nl: 'Meer resultaten dan getoond — verfijn de zoekterm.',
                                   en: 'More results than shown — narrow the search term.' },
  'wizard.no_ecv':               { nl: 'Signbank-export ontbreekt op deze server; alleen lokale glossen zijn doorzocht.',
                                   en: 'Signbank export is missing on this server; only local glosses were searched.' },
  'wizard.btn.search':           { nl: 'Zoeken',                        en: 'Search' },
  'wizard.btn.create':           { nl: 'Als nieuwe glos toevoegen',     en: 'Add as new gloss' },
  'wizard.btn.confirm':          { nl: 'Bevestig',                      en: 'Confirm' },
  'wizard.btn.adopt':            { nl: 'Overnemen',                     en: 'Adopt' },
  'wizard.btn.batch_start':      { nl: 'Batch activeren',               en: 'Start batch' },
  'wizard.btn.batch_next':       { nl: 'Volgende',                      en: 'Next' },
  'wizard.batch.progress':       { nl: '{n} van {total}',               en: '{n} of {total}' },
  'wizard.adopted':              { nl: 'Overgenomen',                   en: 'Adopted' },
  'wizard.msg.empty':            { nl: 'Vul een glos in',               en: 'Enter a gloss' },
  'wizard.msg.empty_list':       { nl: 'De glos lijst is leeg',         en: 'The gloss list is empty' },
  'wizard.msg.free':             { nl: 'Glos bestaat nog niet. {glos} aanmaken?',
                                   en: 'Gloss does not exist yet. Create {glos}?' },
  'wizard.msg.exists':           { nl: 'Glos bestaat al. Laatste letter toegevoegd: {glos}. Aanmaken?',
                                   en: 'Gloss already exists. Suffix added: {glos}. Create it?' },
  'wizard.msg.no_free_name':     { nl: 'Alle achtervoegsels A t/m Z zijn al in gebruik',
                                   en: 'Every suffix A–Z is already in use' },
  'wizard.msg.created':          { nl: '{glos} is aangemaakt.',         en: '{glos} was created.' },
  'wizard.toast.adopted':        { nl: '{glos} overgenomen uit Signbank',
                                   en: '{glos} adopted from Signbank' },
  'wizard.toast.create_failed':  { nl: 'Aanmaken mislukt: {msg}',       en: 'Create failed: {msg}' },

  // ── User activity page (activity.html) ─────────────────────────
  'activity.title':              { nl: 'Gebruikersactiviteit',          en: 'User activity' },
  'activity.back':               { nl: 'Terug',                         en: 'Back' },
  'activity.denied':             { nl: 'Deze pagina is alleen voor beheerders.',
                                   en: 'This page is for administrators only.' },
  'activity.error':              { nl: 'Laden mislukt: {message}',      en: 'Loading failed: {message}' },
  'activity.never':              { nl: 'Nooit',                         en: 'Never' },
  'activity.blocked':            { nl: 'Geblokkeerd',                   en: 'Blocked' },
  'activity.deleted_user':       { nl: 'Verwijderde gebruiker',         en: 'Deleted user' },
  'activity.role.admin':         { nl: 'Admin',                         en: 'Admin' },
  'activity.role.user':          { nl: 'User',                          en: 'User' },
  'activity.filter.user':        { nl: 'Gebruiker',                     en: 'User' },
  'activity.filter.all_users':   { nl: '\u2014 alle gebruikers \u2014',    en: '\u2014 all users \u2014' },
  'activity.filter.from':        { nl: 'Van',                           en: 'From' },
  'activity.filter.to':          { nl: 'Tot en met',                    en: 'Until' },
  'activity.filter.page_size':   { nl: 'Per pagina',                    en: 'Per page' },
  'activity.filter.apply':       { nl: 'Toepassen',                     en: 'Apply' },
  'activity.filter.reset':       { nl: 'Reset',                         en: 'Reset' },
  'activity.card.visits':        { nl: 'Bezoeken in periode',           en: 'Visits in period' },
  'activity.card.active_users':  { nl: 'Actieve gebruikers',            en: 'Active users' },
  'activity.card.pages':         { nl: 'Pagina\u2019s (top 10)',         en: 'Pages (top 10)' },
  'activity.card.shown':         { nl: 'Regels in selectie',            en: 'Rows in selection' },
  'activity.users.title':        { nl: 'Per gebruiker',                 en: 'Per user' },
  'activity.users.col.user':     { nl: 'Gebruiker',                     en: 'User' },
  'activity.users.col.role':     { nl: 'Rol',                           en: 'Role' },
  'activity.users.col.last_seen':{ nl: 'Laatst gezien',                 en: 'Last seen' },
  'activity.users.col.last_page':{ nl: 'Laatste pagina',                en: 'Last page' },
  'activity.users.col.visits':   { nl: 'Bezoeken',                      en: 'Visits' },
  'activity.users.filter_hint':  { nl: 'Klik om op deze gebruiker te filteren',
                                   en: 'Click to filter on this user' },
  'activity.pages.title':        { nl: 'Drukste pagina\u2019s',          en: 'Busiest pages' },
  'activity.pages.col.page':     { nl: 'Pagina',                        en: 'Page' },
  'activity.pages.col.last_visit':{ nl: 'Laatste bezoek',               en: 'Last visit' },
  'activity.pages.col.visits':   { nl: 'Bezoeken',                      en: 'Visits' },
  'activity.events.title':       { nl: 'Activiteitenlog',               en: 'Activity log' },
  'activity.events.col.when':    { nl: 'Wanneer',                       en: 'When' },
  'activity.events.col.user':    { nl: 'Gebruiker',                     en: 'User' },
  'activity.events.col.page':    { nl: 'Pagina',                        en: 'Page' },
  'activity.events.empty':       { nl: 'Geen activiteit in deze periode.',
                                   en: 'No activity in this period.' },
  'activity.events.meta':        { nl: '{first}\u2013{last} van {total} \u2014 {from} t/m {to}',
                                   en: '{first}\u2013{last} of {total} \u2014 {from} to {to}' },
  'activity.pager.prev':         { nl: 'Vorige',                        en: 'Previous' },
  'activity.pager.next':         { nl: 'Volgende',                      en: 'Next' },
  'activity.pager.page_of':      { nl: 'Pagina {page} van {pages}',     en: 'Page {page} of {pages}' },
};
